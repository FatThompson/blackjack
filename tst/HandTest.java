...
public class HandTest {
  ...
  public void updateBustTest(){
    ...
    hand.addCard(nonAce1);
    Assertions.assertEquals(false, hand.updateBust(), "1+9");

    hand.addCard(nonAce2);
    Assertions.assertEquals(false, hand.updateBust(), "ace+9+8");
  ...
  public void cardsTest(){
    ...
    Assertions.assertEquals(returnstatement.toString(), hand.cards().toString());
